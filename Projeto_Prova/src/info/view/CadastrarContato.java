...
public class CadastrarContato extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarContato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
